...
4. Ο πελάτης επιλέγει “Add Payment Method”
5. Ο πελάτης εισάγει στοιχεία κάρτας/wallet
...
- Το σύστημα πρέπει να είναι διαθέσιμο 99% μηνιαίως, ώστε ο χρήστης να μπορεί οποιαδήποτε στιγμή να δει φορτιστές, τιμές ή να κάνει κράτηση
- Μικρής διάρκειας διακοπές επιτρέπονται μόνο για τεχνική συντήρηση ή αναβάθμιση προγραμματισμένη μόνο σε ώρες χαμηλής κίνησης. Σε αυτές τις περιπτώσεις πρέπει να εμφανίζεται ενημερωτικό μήνυμα στον χρήστη
...
- Ύποπτες κινήσεις, όπως επανειλημμένες αποτυχημένες συνδέσεις, θα καταγράφονται
- Τα προσωπικά δεδομένα προστατεύονται και χρησιμοποιούνται μόνο για όσο χρειάζεται
